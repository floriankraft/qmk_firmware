...
// Removed this function as it is now replaced by "i2c_transmit" in i2c_master.h
...
i2c_status_t tiny85_i2c_tx(const uint8_t *data, uint8_t length) {
    ...
    // Replaced call to "i2c_transmit_buf" with the following line.
    // It looks as if "i2c_transmit" in i2c_master.h takes
    // exactly the same parameters as "i2c_transmit_buf".
